...
export const projectsData = [
    ...
    },
    {
        ...
        category: ["Design","Web"],
        skills: ["Brand Identity", "UX/UI design", "SEO optimization", "Digital Marketing Strategies", "Google Ads", "Social Media Promotion","Graphic Design"],
        descriptions: "",
    ...
    },
    {
        ...
        title: "Logo Design",
        category: ["Design"],
        skills: ["Logo Design", "Color Concept", "Brand Identity"],
       descriptions: "",
    ...
    },
    {
        ...
        category: ["Web"],
        skills: ["UX/UI design", "Web Development","Wordpress","PHP","SEO Performance", "Digital Marketing Strategies", "Google Ads"],
        descriptions: "",
